/* PrismJS 1.29.0, MIT License, (c) Lea Verou and contributors, https://prismjs.com/ */
/*!
 * Prism 1.29.0 bundle, self-hosted (replaces the per-page cdnjs script tags).
 * Concatenated from https://cdnjs.cloudflare.com/ajax/libs/prism/1.29.0/
 *   prism.min.js (the default cdnjs core build: markup, css, clike, javascript)
 ...
 * plus the html->markup alias previously inlined in layouts/framework.
 */
...
if (typeof Prism !== 'undefined' && Prism.languages.markup && !Prism.languages.html) { Prism.languages.html = Prism.languages.markup; }
