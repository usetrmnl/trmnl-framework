...
module FrameworkHelper
  ...
  def framework_intro_paragraphs
    @framework_intro_paragraphs ||= {
      ...
      'v3_overview' => 'Framework 3.2 adds themes, adaptive charts and icons, a JavaScript paint API, rebuilt borders and strokes, Text Scale, complete Scale modifiers, and Fluid Mashups. Existing markup keeps working; every 3.2 feature is opt-in.',
