...
module FrameworkHelper
  ...
  def framework_intro_paragraphs
    @framework_intro_paragraphs ||= {
      ...
      'theme_authoring' => 'A theme works by filling in slots: named parts of the screen, like the background, the text, or the title bar, that you point at new colors. This page walks through the workflow: start from the boilerplate, map your slots, register the id, and lint.',
      ...
      'v3_overview' => 'Framework 3.2 adds themes, adaptive charts and icons, a JavaScript paint API, and Fluid Mashups. Existing markup keeps working; every 3.2 feature is opt-in.',
